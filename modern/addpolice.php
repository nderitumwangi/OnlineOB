...
<body class="skin-blue fixed-layout lock-nav">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Police system</p>
        </div>
    </div>
    <!-- ============================================================== -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center">
                                    <div>
                                        <h4 class="card-title"> Add Police Oficer</h4>
                                ...
                                <form class="form">
                                    <div class="form-group m-t-20 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Police ID</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="" id="example-text-input">
                                        </div>
                                    </div>
                                   <div class="form-group m-t-20 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Police Name </label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="" id="example-text-input">
                                        </div>
                                    </div>
                                  ...
                                  <div class="form-group m-t-20 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Email Adress</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="" id="example-text-input">
                                        </div>
                                    </div>
